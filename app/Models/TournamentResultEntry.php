 ...
 * 6): who entered or corrected which result, and when. `previous` is the
 ...
 */
#[Fillable(['tournament_id', 'tournament_match_id', 'user_id', 'user_name', 'result', 'previous', 'created_at'])]
class TournamentResultEntry extends Model
{
    ...
    {
        return ['result' => 'array', 'previous' => 'array', 'created_at' => 'datetime'];
    }
