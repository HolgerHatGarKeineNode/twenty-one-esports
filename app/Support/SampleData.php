...
class SampleData
{
    ...
    public static function finishedBlocks(): array
    {
        return [
            ...
            self::block('#107', 'chess', __('Blitz'), '1–0', 'lena.k', __(':n min ago', ['n' => 31]), 'lena.k', __('vs :name', ['name' => 'pillpusher']), route('games.show', 107), __('#107, chess blitz, finished 1–0, won by lena.k against pillpusher, 31 minutes ago')),
            self::block('#108', 'chess', __('Daily'), '½–½', __('Draw'), __(':n min ago', ['n' => 18]), 'rbf_rita', __('vs :name', ['name' => 'hashhodler']), route('games.show', 108), __('#108, casual chess daily game, finished ½–½, draw between rbf_rita and hashhodler, 18 minutes ago'), casual: true),
            self::block('#109', 'chess', __('Blitz'), '0–1', 'kai_blitz', __(':n min ago', ['n' => 6]), 'feebump', __('vs :name', ['name' => 'kai_blitz']), route('games.show', 109), __('#109, chess blitz, finished 0–1, won by kai_blitz against feebump, 6 minutes ago, newest block'), newest: true),
        ];
    }
    ...
    public static function runningBlocks(): array
    {
        return [
            ...
            self::block('#110', 'chess', __('Daily'), __('move :n', ['n' => 14]), __(":name's turn", ['name' => 'lena.k']), __('running'), 'lena.k', __('vs :name', ['name' => 'nonce_nick']), route('games.show', 110), __("#110, chess daily game, running, move 14, lena.k's turn, lena.k vs nonce_nick"), state: 'live', level: '35%', word: true),
